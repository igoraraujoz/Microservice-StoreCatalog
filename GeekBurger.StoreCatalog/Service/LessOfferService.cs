...
{
    /// <summary>
    /// Serviço responsável pelos disparos de mensagem para o Topico UserWithLessOffer
    /// </summary>
    public class LessOfferService : ILessOfferService
    {
        ...
        public LessOfferService(IMapper mapper, IConfiguration configuration)
        {
            _mapper = mapper;
        ...
        {
            var lessOffer = Encoding.UTF8.GetBytes(message);
