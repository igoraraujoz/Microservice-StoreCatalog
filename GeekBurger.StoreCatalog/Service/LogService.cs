...
{
    /// <summary>
    /// Service responsable to send message to topic Log
    /// </summary>
    public class LogService : ILogService
    {
        ...
        {
            //Padrão solicitado pelo Professor.
            //YYYYMMDD HH:mm STORECATALOG: ________________________
            message = $"{DateTime.Now.ToString("yyyyMMdd HH:mm")} STORECATALOG {message}";

            var log = Encoding.UTF8.GetBytes(message);
